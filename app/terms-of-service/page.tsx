...
export default function TermsAndConditionsPage() {
  const sections = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "TickettoEurope.com is an independent travel agency platform operated by Noam Flyers Inc. TickettoEurope.com is not an airline. TickettoEurope.com does not operate aircraft. TickettoEurope.com does not control airline schedules, aircraft swaps, staffing, airport operations, baggage systems, check-in counters, boarding decisions, or air-traffic events."
        },
        {
          sub: "Definitions",
          text: "For purposes of these Terms: 'Travel Supplier' means any airline, codeshare carrier, partner carrier, consolidator, wholesaler, GDS-linked supplier, hotel, transportation provider, or other travel-service provider whose inventory or rules apply to your booking. 'Booking Request' means your request to search, reserve, or purchase a travel service through TickettoEurope.com. 'Ticketed' means that an airline ticket has been issued and/or that the relevant supplier reservation has been made and confirmed with an identifying reference such as a ticket number, PNR, reservation number, or record locator."
        },
        {
          sub: "Acceptance, Eligibility and Permitted Use",
          text: "You may use TickettoEurope.com only if you are legally capable of entering a binding contract. You must provide accurate information and use the platform only for legitimate travel-shopping, travel-booking, and booking-servicing purposes."
        },
        {
          sub: "Supplier Terms and Incorporated Airline Rules",
          text: "By booking through TickettoEurope.com, you acknowledge that your journey is subject not only to these Terms but also to the rules of the relevant Travel Supplier. These underlying airline terms may include liability limits, baggage limits, check-in rules, refusal-to-carry provisions, schedule-change rights, rerouting provisions, and claim deadlines."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          text: "TickettoEurope.com supports two primary booking channels: Online self-service and Assisted phone booking. Online self-service allows you to search, compare, enter passenger details, review the total, and pay through the website yourself. Assisted phone booking involves speaking with an agent who helps research options, explains fare conditions, enters data, and assists with placing the booking."
        },
        {
          sub: "Dynamic Pricing and Fare Accuracy",
          text: "Air fares are dynamic. Inventory, booking class, seat availability, route combinations, carrier-imposed charges, and taxes may change before ticketing. Every quote shown on TickettoEurope.com should therefore be understood as subject to availability, subject to fare-rule validation, subject to supplier confirmation, and subject to correction of a genuine pricing or tax error."
        },
        {
          sub: "Total Price Disclosure, Taxes and Surcharges",
          text: "Where an airfare is advertised or displayed as a price to purchase a ticket, applicable mandatory government taxes and fees and mandatory carrier-imposed charges should be reflected as required by applicable law. The total price shown before payment may include: Base fare, Carrier-imposed surcharge, Government taxes and airport charges, TickettoEurope.com service fee, Optional airline extras, and Airport/border/entry charges not collected at booking."
        },
        {
          sub: "Payment Authorisation, Merchant of Record and Secure Processing",
          text: "Payments made through TickettoEurope.com are processed by Noam Flyers Inc. using payment methods made available during checkout or communicated by an authorised agent during an assisted booking flow. TickettoEurope.com may require full payment at the time of booking unless an instalment or deferred-payment option is expressly offered."
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "The U.S. Department of Transportation's 24-hour rule for qualifying direct-airline bookings does not automatically apply to tickets purchased through travel agents or online travel agencies. TickettoEurope.com therefore adopts the following position: a penalty-free cancellation is not automatically guaranteed merely because the request falls within 24 hours."
        },
        {
          sub: "Voluntary Changes and Exchanges",
          text: "If you ask to change an existing ticket: the airline or validating carrier must permit the change; the new itinerary must have eligible inventory; any fare difference must be paid; any airline exchange/change penalty must be paid where applicable; any TickettoEurope.com post-ticket exchange fee may apply; and the reissued ticket may carry new or different fare rules."
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "Because TickettoEurope.com is an independent travel agency and not an operating carrier, our liability is limited to the services we actually perform. To the maximum extent permitted by applicable law, TickettoEurope.com shall not be liable for losses arising from airline cancellations, delays, schedule changes, rerouting, missed connections, aircraft substitutions, denied boarding, oversales, seating changes, baggage loss/delay/damage, and other supplier-related issues."
        },
        {
          sub: "Indemnity",
          text: "You agree to indemnify and hold harmless Noam Flyers Inc., TickettoEurope.com, and their officers, employees, contractors, processors, and service providers against losses, costs, claims, liabilities, penalties, and expenses arising out of: your breach of these Terms; inaccurate passenger information supplied by you; violation of supplier rules or applicable law; fraudulent use of a payment instrument; and misuse of the platform."
        },
        {
          sub: "Verification, Fraud Controls and Sanctions Screening",
          text: "Travel transactions may involve fraud, card misuse, identity mismatch, and regulatory controls. TickettoEurope.com may therefore conduct: cardholder verification; billing-address verification; device-risk checks; document checks; duplicate-booking checks; fraud screening; sanctions screening; and other reasonable security checks."
        },
        {
          sub: "Privacy Summary",
          text: "TickettoEurope.com may collect and process information required to search, book, ticket, confirm, service, cancel, refund, or otherwise administer travel arrangements. This may include: traveller names; contact details; itinerary information; payment information; billing information; passport or travel-document information where necessary."
        },
        {
          sub: "Advertiser and Affiliate Disclosure",
          text: "TickettoEurope.com may display sponsored placements, paid search or metasearch traffic, affiliate links, co-branded promotional content, and promotional rates funded partly or entirely by partners. Where TickettoEurope.com receives a commission, referral payment, advertising payment, or other material benefit connected with presented content, the relationship may be disclosed where appropriate."
        }
      ]
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "You agree that TickettoEurope.com may communicate with you electronically through: email; SMS; website notices; account/dashboard notices; booking messages; or other digital communications. These communications may concern bookings, payments, schedule changes, cancellations, servicing requests, fraud verification, refund status, or policy updates."
        },
        {
          sub: "Intellectual Property and Acceptable Website Use",
          text: "All TickettoEurope.com platform content, except third-party airline or supplier content used under applicable rights, belongs to Noam Flyers Inc. or its licensors. You may not: copy, mirror, scrape, frame, or harvest the platform without permission; use bots or scripted processes to query fares at scale; or interfere with site security or payment flows."
        },
        {
          sub: "Changes to These Terms, Severability, Waiver and Survival",
          text: "TickettoEurope.com may amend these Terms from time to time to reflect changes in law, payment rules, supplier practice, product design, service-fee structures, dispute processes, or internal risk controls. Updated Terms become effective when posted unless a different effective date is stated."
        }
      ]
    }
  ];
  ...
  const snippets = [
    { title: "Independent Agency Status", text: "TickettoEurope.com is operated by Noam Flyers Inc., an independent travel agency. We are not an airline and do not operate flights." },
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen bg-gradient-to-b from-white via-[#f5f5f5] to-white pt-16 sm:pt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-xs sm:text-sm mb-6">
            <NextLink href="/" className="flex items-center gap-1 text-black hover:text-black/60 transition-colors font-medium">
              <Home className="w-3.5 h-3.5" />
              Home
            </NextLink>
            <span className="text-black/30">›</span>
            <span className="text-black/60 font-medium">Terms & Conditions</span>
          </nav>
          ...
          <div className="relative mb-10 overflow-hidden rounded-2xl p-8 sm:p-12" style={{
            ...
            <div className="absolute inset-0 opacity-10" style={{
              background: `radial-gradient(circle at 20% 50%, #ffffff, transparent 70%)`
            }} />
          ...
          <div className="mb-10 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center gap-3">
              ...
              <span className="ml-auto text-xs text-black/40 bg-gray-100 px-2 py-1 rounded-full border border-gray-200">
              ...
              {sections.map((section) => {
                ...
                return (
                  <a
                    key={section.id}
                    href={`#${section.id}`}
                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-all duration-200 group border border-transparent hover:border-gray-200"
                  >
                    ...
                    <ChevronRight className="w-3.5 h-3.5 text-black/20 group-hover:text-black transition-colors flex-shrink-0" />
                  </a>
                );
              })}
            </div>
            ...
            {sections.map((section) => {
              ...
              return (
                <div
                  key={section.id}
                  id={section.id}
                  className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden scroll-mt-20 transition-all hover:shadow-md"
                >
                  {/* Section Header */}
                  <div className="px-6 py-4 border-b border-gray-200 flex items-center gap-3 bg-gradient-to-r from-gray-50 to-white">
                    ...
                    <span className="ml-auto text-xs text-black/30">Section</span>
                  </div>
                      ...
                      <div key={index} className="group">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-black/70 leading-relaxed text-justify">
                              {sub.text}
                            </p>
                          </div>
                        </div>
                        {index < section.content.length - 1 && (
                          <div className="ml-5 mt-3 border-l-2 border-gray-200 h-2" />
                        )}
                      </div>
                    ))}
                  </div>
          ...
          <div className="mt-10 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white flex items-center gap-3">
              <div className="p-1.5 rounded-lg bg-gray-200">
                <MessageSquare className="w-4 h-4 text-black" />
              </div>
              <h2 className="text-sm font-semibold text-black">Customer-Facing Snippets</h2>
              <span className="ml-auto text-xs text-black/40 bg-gray-100 px-2 py-1 rounded-full border border-gray-200">
                Quick Reference
              </span>
            </div>
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              {snippets.map((snippet, index) => (
                <div key={index} className="p-4 rounded-lg border border-gray-200 hover:border-black/30 transition-all hover:shadow-sm bg-gray-50 group">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-4 h-4 text-black mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-xs font-semibold text-black uppercase tracking-wider mb-0.5">
                        {snippet.title}
                      </h4>
            ...
            <div className="px-6 py-3 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button className="p-1.5 rounded-lg hover:bg-gray-200 transition-colors text-black/40 hover:text-black">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-3 px-5 py-2.5 bg-black text-white rounded-lg font-semibold hover:bg-black/90 transition-all duration-300 hover:scale-105 shadow-md"
              >
  ...
  <div className="flex items-center gap-3 mb-3">
    ...
    <h3 className="text-sm font-semibold text-black">Email Support</h3>
  </div>
  <p className="text-sm text-black/60 leading-relaxed">
    Send us an email and we'll get back to you within 24 hours.
  </p>
  <a
    href="mailto:Reservations@cheapflightssolution.com"
    className="inline-flex items-center gap-2 mt-3 px-5 py-2.5 border-2 border-black rounded-lg font-semibold transition-all duration-300 hover:bg-black hover:text-white group"
  >
    <Mail className="w-4 h-4 group-hover:text-white" />
    <span className="group-hover:text-white">Email Support</span>
  </a>
</div>
          </div>
